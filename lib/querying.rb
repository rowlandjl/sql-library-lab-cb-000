...
def select_name_and_series_subgenres_of_authors
  "select authors.name, subgenres.name from series left join subgenres on series.subgenre_id = subgeneres.id left join authors on series.author_id = authors.id "
end
